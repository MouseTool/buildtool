// https://github.com/TypeScriptToLua/TypeScriptToLua/blob/master/src/lualib/Set.ts

/**
 * Provides an implementation of `Set`, with an additional `prepend()` method.
 */
export class SetWithPrepend<T> implements Set<T> {
    public static [Symbol.species] = SetWithPrepend;
    ...
    public prepend(value: T): this {
        ...
        if (this.firstKey === undefined) {
            ...
            this.nextKey.set(value, this.firstKey);
            this.previousKey.set(this.firstKey, value);
            this.firstKey = value;
        }
    ...
    public forEach(callback: (value: T, key: T, set: SetWithPrepend<T>) => any): void {
